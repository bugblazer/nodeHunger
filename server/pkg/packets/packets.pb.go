...
func (x *Packet) GetSporesBatch() *SporeBatchMessage {
	if x != nil {
...
type Packet_SporesBatch struct {
	SporesBatch *SporeBatchMessage `protobuf:"bytes,12,opt,name=spores_batch,json=sporesBatch,proto3,oneof"`
}
...
const file_packets_proto_rawDesc = "" +
	...
	"\x1fFinishedBrowsingHiscoresMessage\"\xd7\b\n" +
	"\x06Packet\x12\x1b\n" +
	...
	"\fspores_batch\x18\f \x01(\v2\x1a.packets.SporeBatchMessageH\x00R\vsporesBatch\x12I\n" +
	...
	"\x1afinished_browsing_hiscores\x18\x11 \x01(\v2(.packets.FinishedBrowsingHiscoresMessageH\x00R\x18finishedBrowsingHiscoresB\x05\n" +
